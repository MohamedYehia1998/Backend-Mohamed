...
@section('title')
    <h1 style="color: #fa6362">Add Phone Number to Student {{$student->firstname}} {{$student->lastname}}</h1>
...
@section('table')
    ...
    <form action="{{route('student.phone.store', $student->id)}}" method = "POST">
        @csrf
        @method('POST')
        ...
        <input class="first-name" type="text" name="new_phone" required >
